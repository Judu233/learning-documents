...
相关概念：
- Tilemap 是 2D 游戏中瓦片地图的组件，一个存储和操作 Tile 资源的系统，用来创建 2D 关卡。
...
- 点朝顶部的六角形瓦片示例  
![](../../imgs/unity/base/04_2DHexMap_1.png)   
- 平边朝顶部的六角形瓦片示例  
![](../../imgs/unity/base/04_2DHexMap_2.png)   
...
![](../../imgs/unity/base/04_unity_custom_axis.png)
