 ...
 * @features: 功能
 * @description: 说明
 * @Date: 2022-05-02 00:25:26
 * @Author: judu233(769471424@qq.com)
 * @LastEditTime: 2022-06-15 23:54:29
 * @LastEditors: judu233
-->
# docsify快速搭建教程
!>[docsify官方教程](https://docsify.js.org/#/zh-cn/quickstart)

## docsify 是什么
一个文档站点生成器，可以自动地将 Markdown 中的标题生成目录，并且可以配合码云可以快速搭建一个小型的文档网站，整个页面的配色和布局也十分舒适，和 Gitbook ，vuepress  不同，docsify 不会生成静态的 HTML 文件，但是 SEO 不好
...
<body>
  ...
  <script>
    window.$docsify = {
      name: '学习库',
      repo: 'you git url',
      coverpage: true,  //开启渲染封面
      loadSidebar: true,//设置侧边栏
      loadNavbar: true, //配置导航
      maxLevel: 5, 
      subMaxLevel: 4, 
      mergeNavbar: true,
  ...
  <!-- 在代码块上添加一个简单的Click to copy按钮来允许用户从你的文档中轻易地复制代码-->
  <script 
  src="//cdn.jsdelivr.net/npm/docsify-copy-code/dist/docsify-copy-code.min.js">
  </script>
  <!-- 统计字数的 -->
  <script src="//unpkg.com/docsify-count/dist/countable.js"></script>
  <!-- 一个docsify插件，用于显示标记中的选项卡式内容 -->
...
const getFixedUrl = (req) => {
    ...
    // max-age on mutable content is error-prone, 
    //with SW life of bugs can even extend.
    // Until cache mode of Fetch API landed,
    // we have to workaround cache-busting with query string.
    // Cache-Control-Bug: 
...
## 使用该框架搭建的案例展示
- [styled-wind](https://styled-wind.netlify.app/)
  - CSS-in-JS库，写在styled组件之上。它继承了样式组件的所有内容，还为您提供了使用顺风类名和样式组件的灵活性。
- [pyecharts](https://pyecharts.org)
  - pyecharts百度开源的数据可视化图标文档。
